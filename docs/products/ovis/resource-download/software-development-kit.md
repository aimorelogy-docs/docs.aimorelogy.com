...
description: Access the Ovis SDK source code and official Docker images.
---

# Software Development Kit

The following resources provide the Ovis SDK source code and the Docker images used for SDK compilation and TPU development.
